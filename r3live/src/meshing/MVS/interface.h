...
// invalid index
constexpr uint32_t NO_ID_D {std::numeric_limits<uint32_t>::max()};
...
struct Interface
{
	...
	struct Image {
		...
		Image() : platformID(NO_ID_D), cameraID(NO_ID_D), poseID(NO_ID_D), ID(NO_ID_D) {}

		bool IsValid() const { return poseID != NO_ID_D; }
